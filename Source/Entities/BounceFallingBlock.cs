...
namespace Celeste.Mod.BounceHelper {
    [CustomEntity("BounceHelper/BounceFallingBlock")]
    [Tracked(false)]
    public class BounceFallingBlock : Solid
    {
        ...
        public BounceFallingBlock(Vector2 position, char tile, int width, int height, bool finalBoss, bool behind, bool climbFall)
        ...
        public BounceFallingBlock(EntityData data, Vector2 offset)
