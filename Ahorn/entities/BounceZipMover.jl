module BounceHelperBounceZipMover
...
const placements = Ahorn.PlacementDict(
    "Bounce Zip Mover (Bounce Helper)" => Ahorn.EntityPlacement(
        BounceZipMover,
        "rectangle",
        Dict{String, Any}(),
        function(entity)
...
Ahorn.nodeLimits(entity::BounceZipMover) = 1, 1

Ahorn.minimumSize(entity::BounceZipMover) = 16, 16
Ahorn.resizable(entity::BounceZipMover) = true, true

function Ahorn.selection(entity::BounceZipMover)
...
function getTextures(entity::BounceZipMover)
...
function renderZipMover(ctx::Ahorn.Cairo.CairoContext, entity::BounceZipMover)
    x, y = Ahorn.position(entity)
    nx, ny = Int.(entity.data["nodes"][1])
...
function Ahorn.renderAbs(ctx::Ahorn.Cairo.CairoContext, entity::BounceZipMover, room::Maple.Room)
